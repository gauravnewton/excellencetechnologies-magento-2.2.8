...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    /**
     * @var \Excellence\PushNotification\Model\ResourceModel\Templates\Collection
     */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                'header' => __('Icon'),
                'index' => 'icon',
                'renderer'  => '\Excellence\PushNotification\Block\Adminhtml\Templates\Grid\Renderer\Image',
            ]
        );
        $this->addColumn(
            'name',
